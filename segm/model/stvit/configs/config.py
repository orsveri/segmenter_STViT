...
_C.LOCAL_RANK = 0
_C.MULTI_SCALE = 'multi_scale_semantic_token1'
_C.USE_CONV_POS = False
_C.RELATIVE_POS = False
_C.SHORTCUT = False
_C.SAMPLE_WINDOW_SIZE = 3
_C.USE_LAYER_SCALE = False
_C.USE_GLOBAL = False
...
#     if args.use_conv_pos:
#         config.USE_CONV_POS = True
#     if args.relative_pos:
#         config.RELATIVE_POS = True
#     if args.shortcut:
#         config.SHORTCUT = True
#     if args.sample_window_size:
#         config.SAMPLE_WINDOW_SIZE = args.sample_window_size
#     if args.use_layer_scale:
#         config.USE_LAYER_SCALE = args.use_layer_scale
#     if args.use_global:
...
def get_stvit_config(config_file, nb_cls=None):
    ...
    if nb_cls:
        config.MODEL.NUM_CLASSES = nb_cls
